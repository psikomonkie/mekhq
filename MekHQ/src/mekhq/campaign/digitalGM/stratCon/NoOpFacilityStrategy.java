...
/**
 * {@link FacilityStrategy} for play types with no facility map (Mapless and Singles). Applying periodic facility
 * effects is a deliberate no-op, mirroring the legacy engine's {@code if (!isUseStratConMapless)} guard.
 *
 * @author Illiani
 * @since 0.50.10
 */
